...
user_file_pages = {}
user_file_indices = {}  # user_id -> {file_index -> file_name}
...
async def upload_file_handler(client, message: Message):
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("📤 Send to Telegram", callback_data=f"dl_{encoded_name}")]
        ])
    ...
    for i in range(0, len(page_files), 2):
        ...
        for j in range(2):
            if i + j < len(page_files):
                ...
                file_index_map[file_id] = file_name
...
async def handle_callback_query(client, callback_query: CallbackQuery):
    ...
    try:
        if data.startswith("dl_"):
            ...
            if user_id in user_file_indices and file_id in user_file_indices[user_id]:
                ...
                try:
                    ...
                    keyboard = InlineKeyboardMarkup([
                        [InlineKeyboardButton("🔗 Direct Download Link", url=presigned_url)],
                        [InlineKeyboardButton("🤖 Download via Bot", url=bot_download_link)],
                        [InlineKeyboardButton("📤 Send to Telegram", callback_data=f"btdl_{file_id}")]
                    ])
            ...
            if user_id in user_file_indices:
                del user_file_indices[user_id]
            message = callback_query.message
            message.text = "/list"
            message.from_user = callback_query.from_user
